 ...
 */
function TransportHandler(trackHandler, cursorDevice, extension) {
    ...
    transport.addIsPlayingObserver(function (pPlaying) {
        ...
        if (playing) {
            playButton.turnOn();
            extension.updatePlayTimeLimit();
        } else {
            playButton.turnOff();
            extension.updatePauseTimeLimit();
        }
    });
    ...
    playButton.setCallback(function (value) {
        ...
        if (modifiers.isShiftDown()) {
            ...
            transport.play();
//            if (!extension.getBlockPlayback()) {
//                transport.play();
//            } else {
//                //host.showPopupNotification("Playback blocked for now - playtimecredit: " + extension.getPlayTimeCredit());
//                extension.updatePlayTimeLimit();
//            }
    ...
    recButton.setCallback(function (value) {
        ...
        if (modifiers.isShiftDown()) { 
            host.showPopupNotification("toggle overdub");
